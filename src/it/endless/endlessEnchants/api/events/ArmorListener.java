...
import it.endless.endlessEnchants.api.events.ArmorEquipEvent.EquipMethod;
...
public class ArmorListener implements Listener {
	...
	private Plugin plugin = Bukkit.getServer().getPluginManager().getPlugin("EndlessEnchants");
