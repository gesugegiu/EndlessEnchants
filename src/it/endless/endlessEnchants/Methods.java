...
import it.endless.endlessEnchants.multisupport.nms.NMS_v1_10_R1;
import it.endless.endlessEnchants.multisupport.nms.NMS_v1_11_R1;
import it.endless.endlessEnchants.multisupport.nms.NMS_v1_7_R4;
import it.endless.endlessEnchants.multisupport.nms.NMS_v1_8_R1;
import it.endless.endlessEnchants.multisupport.nms.NMS_v1_8_R2;
import it.endless.endlessEnchants.multisupport.nms.NMS_v1_8_R3;
import it.endless.endlessEnchants.multisupport.nms.NMS_v1_9_R1;
import it.endless.endlessEnchants.multisupport.nms.NMS_v1_9_R2;
...
public class Methods {
	...
	public static void removeDurability(ItemStack item, Player player) {
		if(item.hasItemMeta()) {
			try {
				if(((Spigot) item.getItemMeta()).isUnbreakable()) {
					return;
				}
